...
<div>
    <div class="padding-15 display-flex justify-content-center">
        ...
        <button
        type="button"
        class="waves-effect waves-light btn margin-right-5"
        ...
        <div class="display-flex">
            ...
            <div>
                <div v-if="pagination && pagination.config" class="display-flex justify-content-center align-items-center padding-bottom-15">
                    <button
              :disabled="pagination.config.page == 1 || pagination.config.page > pagination.config.numOfPage"
            ...
            >Prev</button>
              ...
              <span>{{pagination.config.page}} / {{pagination.config.numOfPage || 0}}</span>
                    ...
                    <button
              :disabled="pagination.config.page == pagination.config.numOfPage || pagination.config.page > pagination.config.numOfPage"
    ...
    <div ref="previewAnswerModal" id="previewAnswerModal" class="modal modal-fixed-footer width-80">
        ...
        <div class="modal-footer">
          ...
          @click="previewAnswerModal.close()"
        >Close</button>
        </div>
    </div>
</div>
